			...
			Recuerda que para iniciar sesión tienes que estar registrado con anterioridad </p>
				...
				Contraseña : <br/> <INPUT type="password" name ="password" required="required"> <br/> 
					<br/><INPUT type="submit" value="Ingresar"> <INPUT type="reset">
					 ...
					 <p>Sino te encuentras registrado puedes acceder como invitado</p>
				<a href="homepage.html"><input type="button" value="Ingresar"></a></center>
				</div>
		</section> 
		<section id="main-content" >
			<center><header>
			...
			<div class="content">
				<a href="SignUp_page.php"><input type="button" value="Registrarme"></a>
